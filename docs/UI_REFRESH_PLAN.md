...
Data rozeznania: 2026-09-09. Status: inwentaryzacja kodu zakończona; W07 `/manager/students`, W08 `/manager/students/:userId`, W09 `/manager/instructors` i W10 `/manager/instructors/:id` zaakceptowane i odhaczone dla nowej rundy UI.
...
- [x] **W10 — Szczegóły instruktora** — `/manager/instructors/:id` — 2026-09-12: zaakceptowany jako wykonany w nowej rundzie UI; układ wyrównany do W08 z lokalnymi zakładkami, tym samym torem bocznym i spokojnym przeglądem bez górnego paska metryk; razem z edycją i potwierdzeniem usunięcia.
- [x] **W11 — Dostępność instruktora** — `/manager/instructors/:id/availability` — 2026-09-12: zaakceptowany jako wykonany w nowej rundzie UI; kompaktowy edytor tygodnia inspirowany Calendly, wspólny zapis, cofanie zmian, ostrzeżenie przed opuszczeniem szkicu, czytelniejszy podgląd wolnych terminów oraz nowe pickery daty/czasu.
...
| F04 Dostępność tygodniowa              | W11, M/A                                | [ManagerInstructorAvailabilityEditor.vue](../app/components/manager/instructors/ManagerInstructorAvailabilityEditor.vue) | Okna dla dni tygodnia, wspólny zapis/usuwanie zmian i odświeżenie podglądu slotów.          | gotowe w W11 — 2026-09-12 |
...
**[KOD]** Standard pól daty i czasu jest opisany w [DATE_TIME_PICKERS.md](./DATE_TIME_PICKERS.md). Przy odświeżaniu formularzy i harmonogramów stosować `UiDatePicker`, `UiTimePicker`, `UiDateTimePicker`, `UiDateRangePicker` oraz `UiWeekPicker` jako domyślne komponenty, bez lokalnych wariantów `V2`.
...
## 15. W10 — szczegóły instruktora, zaakceptowane i odhaczone, 2026-09-12
...
Status: **zaakceptowane i odhaczone 2026-09-12**. W10 jest traktowane jako wykonane w nowej rundzie UI.

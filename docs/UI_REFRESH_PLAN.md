...
Data rozeznania: 2026-09-09. Status: inwentaryzacja kodu zakończona; W07 `/manager/students` zaakceptowany i odhaczony dla nowej rundy UI; W08 `/manager/students/:userId` wdrożony do akceptacji.
...
- [ ] **W08 — Szczegóły kursanta** — `/manager/students/:userId` — 2026-09-11: wdrożona iteracja kartoteki CRM do akceptacji: profil po lewej i zakładki Przegląd / Lekcje / Płatności / Kursy. Widok nadal bez końcowej akceptacji użytkownika.

### Instruktorzy

- [ ] **W09 — Lista instruktorów** — `/manager/instructors` — 2026-09-10: wdrożony wariant CRM do oceny; jeden panel listy, zwarty pasek OSK/liczników, wyszukiwarka, szybkie filtry kwalifikacji, tabela/karty i stany. Pozostaje akceptacja użytkownika oraz pełna kontrola mobile z rekordami po stabilnym załadowaniu danych.
...
| E2 Szczegóły i kalendarz        | [ ] W08 wdrożony, W18 czeka | [ ] W08 do akceptacji            | [ ] W08 wdrożony, W18 czeka | [ ] W08 smoke desktop/mobile | [ ] W08 bez zapisu danych w przeglądarce | [ ]                  |
...
## 14. W08 — szczegóły kursanta, wdrożone do akceptacji, 2026-09-11

Aktualizacja 2026-09-11: wdrożono zaakceptowany kierunek kartoteki CRM z profilem po lewej i zakładkami po prawej. Tymczasowy plan wykonawczy został usunięty po implementacji. W08 nadal czeka na końcową akceptację użytkownika i nie jest odhaczony w głównej checkliście.
...
Do akceptacji: potwierdzić kierunek wizualny na realnym widoku. Problem z kodowaniem opisów kroków procesu został naprawiony 2026-09-11 w backendowym mapperze statusu procesu i zabezpieczony testem regresji.

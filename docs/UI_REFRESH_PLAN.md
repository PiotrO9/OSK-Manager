...
Data rozeznania: 2026-09-09. Status: inwentaryzacja kodu zakończona; pierwsza wersja nowego W07 wdrożona i sprawdzona, czeka na ocenę użytkownika.
...
- [ ] **W07 — Lista kursantów** — `/manager/students` — 2026-09-09: wdrożony układ CRM, sprawdzone lista i dialogi; czeka na ocenę wyglądu oraz ewentualne poprawki przed akceptacją.
...
| E1 Lista kursantów              | [x] 2026-09-09         | [ ] wariant wdrożony do oceny | [x] 2026-09-09        | [x] 2026-09-09   | [ ] zakres wykonanej kontroli w sekcji 10 | [x] wariant roboczy zapisany |
...
**Ocenić wdrożony W07 `/manager/students` i zebrać uwagi do wyglądu.** Na prośbę użytkownika wdrożono bezpośrednio jeden wariant do iteracji, zamiast przygotowywać dwie osobne makiety. Po poprawkach i akceptacji odhaczyć W07, a zaakceptowany kierunek sprawdzić na W08.

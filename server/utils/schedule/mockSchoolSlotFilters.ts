import type { MockSchoolAvailabilitySlot } from '~~/server/utils/instructors/mockSlots';
import { mockCoursesGetById } from '~~/server/utils/courses/mockCoursesList';
import { mockInstructorsListPayload } from '~~/server/utils/instructors/mockInstructorsList';

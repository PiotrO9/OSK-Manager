...
| Obszar  | Pliki                                                                                                                                                                                                                                                  |
| ------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Auth    | `auth/login.post.ts`, `auth/me.get.ts`, `auth/profile/avatar.post.ts`, `auth/logout.post.ts`, `auth/refresh.post.ts`                                                                                                                                   |
...
Logika pomocnicza: domenowe grupy w `server/utils/*/` (`*Bff.ts`, mock adaptery i store).

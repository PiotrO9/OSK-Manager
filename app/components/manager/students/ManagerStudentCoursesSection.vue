...
<template>
    ...
    >
        <div
            class="border-border flex items-start justify-between gap-3 border-b px-5 py-4"
        >
            <div class="space-y-1">
                <h2
        ...
        <div class="p-5">
            ...
            <ul v-else class="space-y-3" role="list">
                <li
                    ...
                    :key="course.id"
                    class="border-border flex flex-col gap-3 rounded-lg border p-4 sm:flex-row sm:items-center sm:justify-between"
                >
                    <div class="min-w-0">
                        <p
                            class="text-foreground text-sm font-bold wrap-break-word"
                        >
